...
import { createStateless } from '../utils/stateless.file';

let statelessCommand = vscode.commands.registerCommand('gk-flutter-getx-pattern.statelessfile', async () => {
    ...
    if (type) {
        ...
        if (name) {
            ...
            if (fs.existsSync(filePath)) {
                ...
                fs.appendFile(filePath, createStateless(capitalizeName, type), () => {
...
export default statelessCommand;